...
class JiraTool(BaseToolPlugin):
    ...
    async def execute(self, args: dict, ctx: ToolExecutionContext) -> ToolResultPayload:
        return ToolResultPayload(
            success=False, error="Jira integration not configured — stub plugin, add JIRA_* credentials"
        )
...
class NotionTool(BaseToolPlugin):
    ...
    async def execute(self, args: dict, ctx: ToolExecutionContext) -> ToolResultPayload:
        return ToolResultPayload(success=False, error="Notion integration not configured — stub plugin")
...
class TrelloTool(BaseToolPlugin):
    ...
    async def execute(self, args: dict, ctx: ToolExecutionContext) -> ToolResultPayload:
        return ToolResultPayload(success=False, error="Trello integration not configured — stub plugin")
...
class SlackTool(BaseToolPlugin):
    ...
    async def execute(self, args: dict, ctx: ToolExecutionContext) -> ToolResultPayload:
        return ToolResultPayload(success=False, error="Slack integration not configured — stub plugin")
...
class StripeTool(BaseToolPlugin):
    ...
    async def execute(self, args: dict, ctx: ToolExecutionContext) -> ToolResultPayload:
        return ToolResultPayload(success=False, error="Stripe integration not configured — stub plugin")
